...
const (
	Subscription_Emit_FullMethodName = "/Subscription/Emit"
)
...
func (c *subscriptionClient) Emit(ctx context.Context, in *Bytes, opts ...grpc.CallOption) (*Err, error) {
	...
	out := new(Err)
	err := c.cc.Invoke(ctx, Subscription_Emit_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedSubscriptionServer should be embedded to have
...
func _Subscription_Emit_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Subscription_Emit_FullMethodName,
	}
