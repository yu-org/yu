...
const (
	Writing_Write_FullMethodName = "/Writing/Write"
)
...
func (c *writingClient) Write(ctx context.Context, in *WriteContext, opts ...grpc.CallOption) (*WriteResult, error) {
	...
	out := new(WriteResult)
	err := c.cc.Invoke(ctx, Writing_Write_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedWritingServer should be embedded to have
...
func (UnimplementedWritingServer) testEmbeddedByValue() {}
...
func RegisterWritingServer(s grpc.ServiceRegistrar, srv WritingServer) {
	// If the following call pancis, it indicates UnimplementedWritingServer was
...
func _Writing_Write_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Writing_Write_FullMethodName,
	}
...
const (
	Reading_Read_FullMethodName = "/Reading/Read"
)
...
func (c *readingClient) Read(ctx context.Context, in *ReadContext, opts ...grpc.CallOption) (*ReadResult, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ReadResult)
	err := c.cc.Invoke(ctx, Reading_Read_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedReadingServer should be embedded to have
// forward compatible implementations.
//
// NOTE: this should be embedded by value instead of pointer to avoid a nil
// pointer dereference when methods are called.
...
func (UnimplementedReadingServer) testEmbeddedByValue() {}
...
func RegisterReadingServer(s grpc.ServiceRegistrar, srv ReadingServer) {
	// If the following call pancis, it indicates UnimplementedReadingServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
...
func _Reading_Read_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Reading_Read_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
